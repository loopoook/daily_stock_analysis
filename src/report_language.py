...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "chip_label": "筹码",
        "chip_profit_label": "获利比例",
        "chip_cost_label": "平均持仓成本",
        "chip_concentration_label": "筹码集中度",
        "chip_health_label": "筹码健康度",
        "volume_meaning_label": "成交量解读",
        "weekly_trend_label": "周线趋势",
        "monthly_trend_label": "月线趋势",
        "northbound_label": "北向资金",
        "bias_status_friendly_label": "当前价位",
        "battle_plan_heading": "作战计划",
        "ideal_buy_label": "理想买入价",
        "secondary_buy_label": "备选买入价",
        "stop_loss_label": "止损价",
        "take_profit_label": "第一止盈价",
        "take_profit_2_label": "第二止盈价",
        "watch_above_label": "突破追入价",
        "risk_reward_label": "风险收益比",
        "suggested_position_label": "建议仓位",
        "entry_plan_label": "进场计划",
        "risk_control_label": "风控要点",
        "add_position_label": "加仓时机",
        "exit_trigger_label": "主动离场条件",
        "checklist_heading": "逐项检查",
        "failed_checks_heading": "需要注意的项目",
        "invalidation_heading": "计划失效条件",
    ...
    "en": {
        ...
        "chip_profit_label": "Profit Ratio",
        "chip_cost_label": "Avg Cost",
        "chip_concentration_label": "Chip Concentration",
        "chip_health_label": "Chip Health",
        "volume_meaning_label": "Volume Reading",
        "weekly_trend_label": "Weekly Trend",
        "monthly_trend_label": "Monthly Trend",
        "northbound_label": "Northbound Flow",
        "bias_status_friendly_label": "Price Position",
        "battle_plan_heading": "Battle Plan",
        "ideal_buy_label": "Ideal Entry",
        "secondary_buy_label": "Secondary Entry",
        "stop_loss_label": "Stop Loss",
        "take_profit_label": "Target 1",
        "take_profit_2_label": "Target 2",
        "watch_above_label": "Breakout Entry",
        "risk_reward_label": "Risk/Reward",
        "suggested_position_label": "Position Size",
        "entry_plan_label": "Entry Plan",
        "risk_control_label": "Risk Control",
        "add_position_label": "Add Position When",
        "exit_trigger_label": "Active Exit When",
        "checklist_heading": "Checklist",
        "failed_checks_heading": "Attention Items",
        "invalidation_heading": "Plan Invalidation",
